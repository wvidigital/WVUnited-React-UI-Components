      ...
      <ChildfinderBox>
        ...
        <div>
          {this.props.data.name &&
            <Heading size={3} font={"Lato"} color={'#333'}>{this.props.data.name}</Heading>}

          {this.props.data.description &&
          <Text background={'transparent'}>{this.props.data.description}</Text>}

          {this.props.data.waiting &&
          <Text background={'#ECF8F4'} color={'#46BB95'} border={true}>{this.props.data.waiting}</Text>}
          <div className="icons">
